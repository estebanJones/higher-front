...
@Component({
  selector: 'app-register-formulaire',
  templateUrl: './register-formulaire.component.html',
  styleUrls: ['./register-formulaire.component.scss']
})
export class RegisterFormulaireComponent implements OnInit {
  ...
  constructor(private httpService: HttpService) {
    this.registerFormulaire = new FormGroup({
      ...
      email: new FormControl('', {
        validators: [
            Validators.required,
            Validators.pattern(RegisterFormulaireComponent.EMAIL_REGX)
        ]
      }),
